    ...
    <div class="container-fluid">
        <div class="form-head d-flex mb-3 mb-md-4 align-items-start">
            <div class="mr-auto d-lg-block">
                <a type="button" class="btn btn-primary mb-2" data-toggle="modal" data-target="#add-role-modal"
                    class="btn btn-primary btn-rounded">+ Add New Role</a>

                <!-- Start Add Role Modal -->
                <div class="modal fade" id="add-role-modal" data-backdrop="static">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <form method="post" action="{{ route('admin.user-management.role.store') }}">
                                @csrf
                                <div class="modal-body">
                                    <div class="form-group">
                                        <input type="text" class="form-control input-default role" id="role"
                                            name="title" required placeholder="Role">
                                    </div>
                                    <div class="form-group">
                                        <select class="multi-select" required name="permissions[]" data-live-search="true"
                                        ...
                                        <div class="d-flex">
                                            @if ($list->trashed())
                                                <a href="javascript:void(0)"
                                                    ...
                                                    title="Restore"
                                                    data-url="{{ route('admin.user-management.role.restore', $encoded_id) }}"
                                                ...
                                                <a href="javascript:void(0)"
                                                    ...
                                                    data-url="{{ route('admin.user-management.role.permanent-delete', $encoded_id) }}"
                                            ...
                                            @else
                                                <a href="javascript:void(0)"
                                                    ...
                                                    title="Edit"
                                                    data-url="{{ route('admin.user-management.role.edit', $encoded_id) }}"
                                                ...
                                                <a href="javascript:void(0)"
                                                    ...
                                                    data-url="{{ route('admin.user-management.role.delete', $encoded_id) }}"
                                                    data-type="delete" data-reload="true"
