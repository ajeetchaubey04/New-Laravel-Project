    ...
    <div class="container-fluid">
        <div class="form-head d-flex mb-3 mb-md-4 align-items-start">
            <div class="mr-auto d-lg-block">
                <a type="button" class="btn btn-primary mb-2" data-toggle="modal" data-target="#add-finance-modal"
                    class="btn btn-primary btn-rounded">+ Add New Finance Type</a>

                <!-- Start Add Finance Type Modal -->
                <div class="modal fade" id="add-finance-modal" data-backdrop="static">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Add Finance Type</h5>
                                <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                                </button>
                            </div>

                            <form method="post" action="{{ route('admin.app-data.finance.store') }}">
                                @csrf
                                <div class="modal-body">

                                    <div class="form-group">
                                        <input type="text" class="form-control input-default finance" id="finance"
                                            name="title" required placeholder="Finance Name">
                                    </div>
                                        ...
                                        <div class="d-flex">
                                            @if ($list->trashed())
                                                <a href="javascript:void(0)"
                                                    ...
                                                    title="Restore"
                                                    data-url="{{ route('admin.app-data.finance.restore', $encoded_id) }}"
                                                ...
                                                <a href="javascript:void(0)"
                                                    ...
                                                    data-url="{{ route('admin.app-data.finance.permanent-delete', $encoded_id) }}"
                                            ...
                                            @else
                                                <a href="javascript:void(0)"
                                                    ...
                                                    title="Edit"
                                                    data-url="{{ route('admin.app-data.finance.edit', $encoded_id) }}"
